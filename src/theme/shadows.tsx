...
export const customShadows = {
  ...
  card: `0 0 2px 0 ${alpha(LIGHT_MODE, 0.24)}, 0 12px 24px -4px ${alpha(LIGHT_MODE, 0.24)}`,
  dropdown: `0 0 2px 0 ${alpha(LIGHT_MODE, 0.24)}, 0 20px 40px -4px ${alpha(LIGHT_MODE, 0.24)}`,
  dialog: `-40px 40px 80px -8px ${alpha(LIGHT_MODE, 0.24)}`,
};
