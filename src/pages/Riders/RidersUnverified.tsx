...
export default function UnverifiedRiders({riders, enable, disable}) {
    ...
    const TableBodyComponent = () => {
        ...
        const filteredRiders = applySortFilter(riders, getComparator(order, orderBy), filterName);
        return (
            <TableBody>
                {filteredRiders.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row, index) => {
