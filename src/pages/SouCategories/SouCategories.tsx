...
const COLUMNS = [
  ...
  { id: 'Namecategory', label: 'category', alignRight: false, searchable: false },
  { id: 'attributes', label: 'Attributes', alignRight: false, searchable: false },
];
...
export default function SouCategories() {
  ...
  async function getSouCat() {
    const res = await SubCategoryAPI.get()
    console.log(' Res ==> ',res);
    setCategories(res);
  }
        ...
        {data.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row, index) => {
          ...
          return (
            ...
            >
              ...
              <TableCell align="left">{row.Namecategory}</TableCell>
      ...
      <Container>
        <Stack direction={'row'} justifyContent={'space-between'} mb={3}>
          ...
          <Button
            ...
            size="medium"
            variant="contained"
            onClick={() => navigate('/dashboard/sou-categories/add')}
          >
            ajouter
          </Button>
        </Stack>
